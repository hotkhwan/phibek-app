...
<style lang="scss">
  ...
  .event-card { overflow: hidden; .media-box { position: relative; height: clamp(180px, 16vw, 260px); overflow: hidden; background: #090a0d; } :global(.event-image) { width: 100%; height: 100%; object-fit: contain; background: #090a0d; } .confidence { position: absolute; top: .75rem; left: .75rem; background: rgba(0,0,0,.72); color: #fff; border-radius: 5px; padding: .25rem .5rem; font-size: .75rem; } .zoom-btn { position: absolute; top: .75rem; right: .75rem; width: 36px; height: 36px; border-radius: 50%; border: 1px solid rgba(255,255,255,.25); color: rgba(255,255,255,.85); background: rgba(0,0,0,.22); backdrop-filter: blur(8px); } }
